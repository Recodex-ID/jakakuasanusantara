                        ...
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-900">{{ $employee->date_of_birth ? $employee->date_of_birth->format('F j, Y') : '-' }}</p>
                                </div>
                                <div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-900">{{ $employee->created_at->format('F j, Y') }}</p>
                                </div>
                                <div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-sm font-medium text-gray-900">{{ $attendanceStats['this_month'] ?? 0 }} days</span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-sm text-gray-600">Total Present</span>
                                    <span class="text-sm font-medium text-green-600">{{ $attendanceStats['total_present'] ?? 0 }}</span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-sm text-gray-600">Total Absent</span>
                                    <span class="text-sm font-medium text-red-600">{{ $attendanceStats['total_absent'] ?? 0 }}</span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-sm text-gray-600">Late Arrivals</span>
                                    <span class="text-sm font-medium text-yellow-600">{{ $attendanceStats['total_late'] ?? 0 }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="space-y-3">
                                    @foreach($recentAttendances as $attendance)
                                        <div class="flex items-center justify-between text-sm">
                                            <div>
                                                <p class="font-medium text-gray-900">{{ $attendance->location->name }}</p>
                                                <p class="text-gray-600">{{ $attendance->date->format('M j, Y') }}</p>
                                            </div>
                                            <div class="text-right">
                                                @if($attendance->check_in)
                                                    <p class="text-green-600">In: {{ $attendance->check_in->format('H:i') }}</p>
                                                @endif
                                                @if($attendance->check_out)
                                                    <p class="text-red-600">Out: {{ $attendance->check_out->format('H:i') }}</p>
                                                @endif
                                            </div>
                                        </div>
                                    @endforeach
