<x-layouts.app>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <form method="GET" action="{{ route('admin.face-galleries.index') }}"
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-3">
                                ...
                                @if ($gallery->description)
                                    <div class="flex items-start space-x-2">
                                        ...
                                        <p class="text-sm text-gray-600">{{ Str::limit($gallery->description, 100) }}
                                        </p>
                                    </div>
                                @endif
                                ...
                                <div class="grid grid-cols-3 gap-4 text-center">
                                    <div>
                                        <div class="text-lg font-semibold text-gray-900">
                                            {{ $gallery->enrolled_faces_count ?? 0 }}</div>
                                        <div class="text-xs text-gray-500">Enrolled Faces</div>
                                    </div>
                                    <div>
                                        <div class="text-lg font-semibold text-gray-900">
                                            {{ $gallery->employees_count ?? 0 }}</div>
                                        <div class="text-xs text-gray-500">Employees</div>
                                    </div>
                                    <div>
                                        <div class="text-lg font-semibold text-gray-900">
                                            {{ $gallery->verifications_count ?? 0 }}</div>
                            ...
                            <div class="mt-4 flex justify-end space-x-2">
                                ...
                                @if ($gallery->enrolled_faces_count == 0)
                                    <form method="POST"
                                        action="{{ route('admin.face-galleries.destroy', $gallery) }}" class="inline"
                    ...
                    <div class="col-span-full">
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-12 text-center">
                                ...
                                <p class="text-gray-500 mb-4">Get started by creating your first face recognition
                                    gallery.</p>
                                <a href="{{ route('admin.face-galleries.create') }}"
