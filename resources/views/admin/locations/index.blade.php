                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg hover:shadow-md transition-shadow">
                        <div class="p-6">
                            ...
                            <div class="space-y-3">
                                ...
                                @if ($location->description)
                                    <div class="flex items-start space-x-2">
                                        ...
                                        <p class="text-sm text-gray-600">{{ Str::limit($location->description, 100) }}
                                        </p>
                                    </div>
                                @endif
                                ...
                                <div class="grid grid-cols-2 gap-4 text-center">
                                    <div>
                                        <div class="text-lg font-semibold text-gray-900">
                                            {{ $location->employees_count }}</div>
                                        <div class="text-xs text-gray-500">Employees</div>
                                    </div>
                                    <div>
                                        <div class="text-lg font-semibold text-gray-900">
                                            {{ $location->attendances_count }}</div>
                            ...
                            <div class="mt-4 flex justify-end space-x-2">
                                <button
                                    onclick="showOnMap({{ $location->latitude }}, {{ $location->longitude }}, '{{ $location->name }}')"
                    ...
                    <div class="col-span-full">
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-12 text-center">
                                ...
                                <p class="text-gray-500 mb-4">Get started by creating your first attendance location.
                                </p>
                                <a href="{{ route('admin.locations.create') }}"
